...
const macro: TableauType[] = [
    {
        title: "Forest Jewel",
        position: [-6, 3, -4.9],
        texture: `${import.meta.env.BASE_URL}photos/macro/1.jpg`,
        description:
    ...
    },
    {
        ...
        position: [0, 3, -4.9],
        texture: `${import.meta.env.BASE_URL}photos/macro/2.jpg`,
        description: "A single stalk of grass",
    },
    {
        title: "A Busy Bumblebee",
        position: [4, 3, -4.9],
        texture: `${import.meta.env.BASE_URL}photos/macro/3.jpg`,
        description:
    ...
    },
    {
        ...
        position: [-6, -2, -4.9],
        texture: `${import.meta.env.BASE_URL}photos/macro/4.jpg`,
        description:
    ...
    },
    {
        ...
        position: [2, -1, -4.9],
        texture: `${import.meta.env.BASE_URL}photos/macro/5.jpg`,
        description:
...
const urbex: TableauType[] = [
    {
        ...
        position: [-6, 3, -4.9],
        texture: `${import.meta.env.BASE_URL}photos/urbex/1.jpg`,
    },
    {
        title: "Forgotten Artistry in Decay",
        position: [0, 3, -4.9],
        texture: `${import.meta.env.BASE_URL}photos/urbex/2.jpg`,
        description: "Inside a crumbling, abandoned room",
    },
    {
        title: "Urban Starry Night",
        position: [4, 3, -4.9],
        texture: `${import.meta.env.BASE_URL}photos/urbex/3.jpg`,
        description:
    ...
    },
    {
        ...
        position: [-6, -2, -4.9],
        texture: `${import.meta.env.BASE_URL}photos/urbex/4.jpg`,
        description:
...
const people: TableauType[] = [
    {
        ...
        position: [-6, 3, -4.9],
        texture: `${import.meta.env.BASE_URL}photos/people/1.jpg`,
        description:
    ...
    },
    {
        ...
        position: [0, 3, -4.9],
        texture: `${import.meta.env.BASE_URL}photos/people/2.jpg`,
        description:
    ...
    },
    {
        ...
        position: [4, 3, -4.9],
        texture: `${import.meta.env.BASE_URL}photos/people/3.jpg`,
        description:
    ...
    },
    {
        ...
        position: [-6, -2, -4.9],
        texture: `${import.meta.env.BASE_URL}photos/people/4.jpg`,
        description:
    ...
    },
    {
        title: "In Motion",
        position: [3, 0, -4.9],
        texture: `${import.meta.env.BASE_URL}photos/people/5.jpg`,
        description:
...
const animals: TableauType[] = [
    {
        ...
        position: [-6, 3, -4.9],
        texture: `${import.meta.env.BASE_URL}photos/animals/1.jpg`,
        description:
    ...
    },
    {
        ...
        position: [0, 3, -4.9],
        texture: `${import.meta.env.BASE_URL}photos/animals/2.jpg`,
        description: "A majestic horse in front of Buckingham Palace",
    },
    {
        title: "Curious Cat in the Sun",
        position: [4, 3, -4.9],
        texture: `${import.meta.env.BASE_URL}photos/animals/3.jpg`,
        description:
    ...
    },
    {
        ...
        position: [-6, -2, -4.9],
        texture: `${import.meta.env.BASE_URL}photos/animals/4.jpg`,
        description:
    ...
    },
    {
        ...
        position: [0, -2, -4.9],
        texture: `${import.meta.env.BASE_URL}photos/animals/5.jpg`,
        description:
    ...
    },
    {
        ...
        position: [6, -2, -4.9],
        texture: `${import.meta.env.BASE_URL}photos/animals/6.jpg`,
        description:
...
const architecture: TableauType[] = [
    {
        ...
        position: [-6, 3, -4.9],
        texture: `${import.meta.env.BASE_URL}photos/architecture/1.jpg`,
        description:
    ...
    },
    {
        title: "Urban Calm",
        position: [0, 3, -4.9],
        texture: `${import.meta.env.BASE_URL}photos/architecture/2.jpg`,
        description:
    ...
    },
    {
        ...
        position: [4, 3, -4.9],
        texture: `${import.meta.env.BASE_URL}photos/architecture/3.jpg`,
        description:
    ...
    },
    {
        ...
        position: [-6, -2, -4.9],
        texture: `${import.meta.env.BASE_URL}photos/architecture/4.jpg`,
        description:
    ...
    },
    {
        ...
        position: [0, -2, -4.9],
        texture: `${import.meta.env.BASE_URL}photos/architecture/5.jpg`,
        description:
    ...
    },
    {
        ...
        position: [6, -2, -4.9],
        texture: `${import.meta.env.BASE_URL}photos/architecture/6.jpg`,
        description:
